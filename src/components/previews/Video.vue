<template>
<div>
    <h3 class="vuefinder__video_preview_modal__title" id="modal-title"
         :title="app.modal.data.item.path">{{ app.modal.data.item.basename }}</h3>
  <div>
    <video class="vuefinder__video_preview_modal__video" preload controls>
...
<style>
.vuefinder__video_preview_modal__title {
  @apply mb-2 text-lg leading-6 font-medium text-gray-900 dark:text-gray-400;
}

.vuefinder__video_preview_modal__video {
